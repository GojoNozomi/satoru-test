...
if (envelopeAutoSendToggle) {
    envelopeAutoSendToggle.addEventListener('click', () => {
        ...
        updateEnvelopeSettingsUI();
        throttledSaveData();
        if (typeof manageEnvelopeAutoSendTimer === 'function') manageEnvelopeAutoSendTimer(true); // ===== 已修改：设置变化后重新计时 =====
...
if (envelopeAutoSendMinValSlider) {
    ...
    envelopeAutoSendMinValSlider.addEventListener('change', () => { throttledSaveData(); if (typeof manageEnvelopeAutoSendTimer === 'function') manageEnvelopeAutoSendTimer(true); });
}
if (envelopeAutoSendMinUnit) {
    envelopeAutoSendMinUnit.addEventListener('change', (e) => {
        ...
        throttledSaveData();
        if (typeof manageEnvelopeAutoSendTimer === 'function') manageEnvelopeAutoSendTimer(true);
    });
}
...
if (envelopeAutoSendMaxValSlider) {
    ...
    envelopeAutoSendMaxValSlider.addEventListener('change', () => { throttledSaveData(); if (typeof manageEnvelopeAutoSendTimer === 'function') manageEnvelopeAutoSendTimer(true); });
}
